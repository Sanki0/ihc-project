...
export default function Juego() {
    ...
    const runCoco = async () => {
        ...
        // https://bucket-hand-detect-uni-dev.s3.amazonaws.com/model.json
        const net = await tf.loadGraphModel('https://bucket-hand-detect-uni-dev.s3.amazonaws.com/model.json')
